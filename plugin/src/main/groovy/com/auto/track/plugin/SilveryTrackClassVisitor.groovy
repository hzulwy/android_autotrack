...
class SilveryTrackClassVisitor extends ClassVisitor implements Opcodes {
    ...
    SilveryTrackClassVisitor(final ClassVisitor classVisitor) {
    ...
    MethodVisitor visitMethod(int access, String name, String desc, String signature, String[] exceptions) {
        ...
        methodVisitor = new DefaultMethodVisitor(methodVisitor, access, name, desc) {
            ...
            void visitInvokeDynamicInsn(String name1, String desc1, Handle bsm, Object... bsmArgs) {
                ...
                try {
                    ...
                    SilveryTrackMethodCell silveryTrackMethodCell = SilveryTrackHookConfig.LAMBDA_METHODS.get(Type.getReturnType(desc1).getDescriptor() + name1 + desc2)
                    if (silveryTrackMethodCell != null) {
                        Handle it = (Handle) bsmArgs[1]
                        mLambdaMethodCells.put(it.name + it.desc, silveryTrackMethodCell)
                    }
                } catch (Exception e) {
                    e.printStackTrace()
                }
            ...
            protected void onMethodEnter() {
                ...
                SilveryTrackMethodCell lambdaMethodCell = mLambdaMethodCells.get(nameDesc)
                if (lambdaMethodCell != null) {
                    ...
                    boolean isStaticMethod = SilveryPluginUtils.isStatic(access)
                    if (!isStaticMethod) {

...
class DatabaseHelper {
    private static final String AutoTrackContentProvider = ".AutoTrackContentProvider/";
    ...
    DatabaseHelper(Context context, String packageName) {
        mContentResolver = context.getContentResolver();
        mAppStart = Uri.parse("content://" + packageName + AutoTrackContentProvider + AutoTrackTable.APP_STARTED.getName());
        mAppEndState = Uri.parse("content://" + packageName + AutoTrackContentProvider + AutoTrackTable.APP_END_STATE.getName());
        mAppPausedTime = Uri.parse("content://" + packageName + AutoTrackContentProvider + AutoTrackTable.APP_PAUSED_TIME.getName());
    }
